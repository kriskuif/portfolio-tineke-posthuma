(() => {
  ...
  function exportThemeMotif(id){
    ...
    if(id==='wandelgids') return `<svg ${common}><path d="M109 31C95 23 79 28 71 42C56 35 41 42 36 57C21 59 14 74 20 88C8 98 11 116 25 124C20 140 34 153 51 150C60 165 78 168 91 158C98 164 105 166 112 164C122 171 138 168 145 157C161 162 177 152 178 136C193 130 198 113 188 101C198 87 190 70 176 67C174 51 157 41 143 47C137 32 120 25 109 31Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="5"/><path d="M95 191C104 166 105 144 101 123M109 191C108 166 111 145 118 126M102 126C92 112 81 102 68 95M104 139C91 126 79 120 65 119M109 128C116 110 128 96 143 87M110 148C123 135 136 128 151 126" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="5"/><path d="M72 193C92 188 128 188 151 194" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="3"/></svg>`;
    if(id==='tijdschrift') return `<svg ${common}><path d="M101 25C111 39 121 48 134 50C127 63 132 74 147 77C138 89 142 101 158 105C147 116 149 128 163 134C151 144 146 157 149 171C133 169 119 174 104 187C99 174 91 163 79 158C82 145 77 135 63 131C75 120 73 108 59 102C71 91 68 79 54 73C67 63 70 51 64 38C79 43 91 36 101 25Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="5"/><path d="M103 188C102 151 101 111 101 36M101 137L76 122M101 115L70 95M101 91L76 70M102 151L129 135M102 126L143 108M102 101L133 78M102 76L124 57" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="4"/><path d="M103 188C108 194 112 198 117 202" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="4"/></svg>`;
    if(id==='dagboek') return `<svg ${common} viewBox="0 0 240 240"><circle cx="120" cy="120" r="96" fill="none" stroke="currentColor" stroke-width="2.5"/><circle cx="120" cy="120" r="78" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="120" cy="120" r="54" fill="none" stroke="currentColor" stroke-width="1.8"/><polygon points="120.0,38.0 125.1,94.5 151.4,44.2 134.4,98.4 178.0,62.0 141.6,105.6 195.8,88.6 145.5,114.9 202.0,120.0 145.5,125.1 195.8,151.4 141.6,134.4 178.0,178.0 134.4,141.6 151.4,195.8 125.1,145.5 120.0,202.0 114.9,145.5 88.6,195.8 105.6,141.6 62.0,178.0 98.4,134.4 44.2,151.4 94.5,125.1 38.0,120.0 94.5,114.9 44.2,88.6 98.4,105.6 62.0,62.0 105.6,98.4 88.6,44.2 114.9,94.5" fill="currentColor" fill-opacity=".20" stroke="currentColor" stroke-width="1.6"/><path d="M120 8L132 102L120 120L108 102Z M232 120L138 132L120 120L138 108Z M120 232L108 138L120 120L132 138Z M8 120L102 108L120 120L102 132Z" fill="currentColor" fill-opacity=".55" stroke="currentColor" stroke-linejoin="round" stroke-width="2"/><path d="M199 41L139 106L120 120L134 93Z M199 199L134 147L120 120L147 134Z M41 199L106 139L120 120L93 134Z M41 41L106 101L120 120L93 106Z" fill="currentColor" fill-opacity=".34" stroke="currentColor" stroke-linejoin="round" stroke-width="2"/><circle cx="120" cy="120" r="17" fill="none" stroke="currentColor" stroke-width="3"/><circle cx="120" cy="120" r="7" fill="currentColor"/></svg>`;
