(() => {
  ...
  function exportThemeMotif(id){
    ...
    if(id==='minimal') return `<svg class="export-motif" aria-hidden="true" viewBox="0 0 240 220">
      <path d="M120 187 C104 184 91 180 80 176 L69 187 L57 182 L61 163 C49 157 39 148 32 136 C24 122 21 107 24 91 C27 75 34 62 45 51 C55 41 67 34 79 29 C91 24 104 21 120 21 C136 21 149 24 161 29 C173 34 185 41 195 51 C206 62 213 75 216 91 C219 107 216 122 208 136 C201 148 191 157 179 163 L183 182 L171 187 L160 176 C149 180 136 184 120 187Z" fill="none" stroke="currentColor" stroke-width="5.2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M120 184 C111 173 102 164 92 158 C82 153 73 151 63 151 M120 184 C129 173 138 164 148 158 C158 153 167 151 177 151" fill="none" stroke="currentColor" stroke-width="3.4" stroke-linecap="round"/>
      <path d="M120 178 C112 153 105 127 100 101 C96 78 92 54 91 31 M120 178 C116 151 113 124 111 97 C110 72 109 46 110 23 M120 178 C120 149 120 120 120 91 C120 66 120 42 120 21 M120 178 C124 151 127 124 129 97 C130 72 131 46 130 23 M120 178 C128 153 135 127 140 101 C144 78 148 54 149 31" fill="none" stroke="currentColor" stroke-width="3.7" stroke-linecap="round"/>
      <path d="M120 178 C108 155 96 131 86 108 C76 86 67 64 61 44 M120 178 C104 158 89 137 76 116 C63 95 52 75 44 58 M120 178 C99 160 80 142 63 123 C47 105 34 88 27 74 M120 178 C132 155 144 131 154 108 C164 86 173 64 179 44 M120 178 C136 158 151 137 164 116 C177 95 188 75 196 58 M120 178 C141 160 160 142 177 123 C193 105 206 88 213 74" fill="none" stroke="currentColor" stroke-width="3.4" stroke-linecap="round"/>
      <path d="M61 163 C77 157 94 158 120 170 C146 158 163 157 179 163" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round"/>
      <path d="M52 57 C56 51 62 49 67 52 C70 45 76 41 82 43 C87 35 94 31 101 34 C107 26 114 24 120 28 C126 24 133 26 139 34 C146 31 153 35 158 43 C164 41 170 45 173 52 C178 49 184 51 188 57" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`;
